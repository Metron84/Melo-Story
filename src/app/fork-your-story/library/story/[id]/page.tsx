          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {story.analysis && (
              <div className="space-y-6">
                ...
                {story.analysis.historicalParallels && (
                  <div 
                    className="p-6 border rounded-sm"
                    style={{ 
                      borderColor: 'var(--fys-earth)',
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {story.analysis.historicalParallels.map((p: { name: string; icon: string; era: string }, i: number) => (
                ...
                {story.analysis.narrativeForks && (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      {[story.analysis.narrativeForks.forkA, story.analysis.narrativeForks.forkB].map((fork, i) => (
                        <Link
                          key={i}
