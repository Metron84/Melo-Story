  ...
  const loadStories = async () => {
    ...
    if (pendingStory) {
      ...
      demoStories.push({
        ...
        word_count: data.wordCount || data.word_count,
        status: 'complete',
        is_public: true,
    ...
    setStats({
      ...
      totalWords: demoStories.reduce((sum, s) => sum + s.word_count, 0),
    ...
    <div className="relative pb-8">
      ...
      <div className="pl-6">
        ...
        <p 
          ...
          style={{ color: 'var(--fys-stone)' }}
        >
          {story.word_count} words · {story.tags.join(', ')}
        </p>
      </div>
    </div>
  );
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <button
            ...
            style={{ color: 'var(--fys-stone)' }}
          >
            {story.is_public ? <Eye size={18} /> : <EyeOff size={18} />}
          </button>
        </div>
